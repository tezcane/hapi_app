...
initProphets() { s
  ...
  prophets.add(Prophet('Prophet', 'Idris', '?', null, null, 2, 'p.Babylon', QV(19,56), nameLatin: 'Enoch', locationBirth: 'p.Babylon', locationDeath: 'p.Hebron, Shaam', tomb: 'Ibrahimi Mosque, Hebron', predecessorAr: 'p.Sheth', successorAr: 'p.', motherAr: 'p.', fatherAr: 'p.', spousesAr: [''], childrenAr: ["p.ʿAnaq'"], relativesAr: [], kitabAr: '―', livedDuring: '?'));
  ...
  prophets.add(Prophet('Prophet', 'Shuʿayb', '?', null, null, 9, 'p.Midian (7:85)', QV(26,178), rasul: QV(26,178), locationBirth: '', locationDeath: '', tomb: '', predecessorAr: '', successorAr: 'p.', motherAr: 'p.', fatherAr: 'p.', spousesAr: [''], childrenAr: [], kitabAr: '―', livedDuring: '?'));
