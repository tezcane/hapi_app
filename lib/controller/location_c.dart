...
/// LocationC is used to get location/gps coordinates.
///
...
class LocationC extends GetxHapi {
  static LocationC get to => Get.find();
  ...
  _updatePosition(Position? position) async {
    ...
    _qiblaDirection =
        LocationC.to.getQiblaBearing(lastKnownCord); // Qibla Direction
