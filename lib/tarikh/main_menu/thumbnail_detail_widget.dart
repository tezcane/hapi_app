...
/// to the right start/end time for the [event].
typedef TapSearchResultCallback = Function(Event event);

/// This widget lays out nicely the [event] provided.
///
/// It shows the [ThumbnailWidget] for that event on the left, and the label with the date of the event
...
class ThumbnailDetailWidget extends StatelessWidget {
  const ThumbnailDetailWidget(this.event,
