...
class Qibla {
  static double qibla(coordinates) {
    ...
    final Coordinates kaabaCord = Coordinates(21.422487, 39.826206);

    // Equation from "Spherical Trigonometry For the use of colleges and schools" page 50
    double term1 = (sin(degreesToRadians(kaabaCord.longitude) -
        degreesToRadians(coordinates.longitude)));
    double term2 = (cos(degreesToRadians(coordinates.latitude)) *
        tan(degreesToRadians(kaabaCord.latitude)));
    double term3 = (sin(degreesToRadians(coordinates.latitude)) *
        cos(degreesToRadians(kaabaCord.longitude) -
            degreesToRadians(coordinates.longitude)));
